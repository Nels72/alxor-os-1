...
1. **Base de connaissance compagnies** — état 2026-06-11 :
   ...
   - ⚠️ Le PDF AXA est une **fiche produit POG**, pas une fiche d'appétence : aucun critère BM/sinistres/résiliation → champs critères null (règle d'or). Pour valider le mapping des critères, fournir une vraie fiche d'appétence.
